...
namespace SendMail.Helpers
{
    ...
    public static class ColorConsole
    {
        ...
        public static void WriteSuccess(string text, bool writeLine = false)
        {
            if (writeLine)
        ...
        /// </summary>
        /// <param name="text">Text to write out</param>
        public static void WriteError(string text, bool writeLine = false)
        {
            if (writeLine)
        ...
        /// </summary>
        /// <param name="text">Text to Write out</param>
        public static void WriteWarning(string text, bool writeLine = false)
        {
            if (writeLine)
        ...
        /// </summary>
        /// <param name="text">Text to write out</param>
        public static void WriteInfo(string text, bool writeLine = false)
        {
            if (writeLine)
